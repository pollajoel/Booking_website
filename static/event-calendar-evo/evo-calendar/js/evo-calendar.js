            ...
            _.initials = {
                ...
                dates: {
					...
					fr: {
                        ...
                        months: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Jullet", "Août", "Septembre", "Octobre", "Novembre", "Decembre"],
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup += '<div class="calendar-events">'+
							...
							'<div class="form-group">'+
								'<label for="exampleFormControlSelect1">Veuillez choisir une balade(*)</label>'+
							...
							//---horaire de depart---
							'<div class="form-group">'+
								'<label for="exampleFormControlSelect1">Choisir une Horaire(*)</label>'+
								'<select class="form-control" id="exampleFormControlSelect1">'+
									'<option>1</option>'+
									'<option>2</option>'+
									'<option>3</option>'+
